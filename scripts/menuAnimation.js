...
$(function() {
  ...
  $menulink.click(function() {
    // if (isOpen) {
    //   $('.wrap .side-menu').css('visibility', 'collapse', 'display', 'none');
    // } else {
    //   $('.wrap .side-menu').css('visibility', 'visible', 'display', 'block');
    // }
  ...
  // $('.wrap .side-menu .menu-text .menu-text').click(function() {
